...
export declare const STEAM_STORE_STRATEGY_NAME = "steam.store.medusa-auth-plugin";
export declare const STEAM_ADMIN_STRATEGY_NAME = "steam.admin.medusa-auth-plugin";
/**
...
export type SteamAuthOptions = {
    ...
    admin?: {
         ...
         */
        verifyCallback?: (container: MedusaContainer, req: Request, identifier: string, profile: Profile, strict?: AuthOptions['strict']) => Promise<null | {
            id: string;
        } | never>;
        expiresIn?: number;
    };
